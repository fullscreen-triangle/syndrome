...
\textbf{(b) Tregs:} Regulatory T cells expressing Foxp3 suppress self-reactive T cells through inhibitory cytokines (IL-10, TGF-$\beta$) and cell contact-dependent mechanisms (CTLA-4, LAG-3). Tregs preferentially recognise high-richness antigens, providing richness-dependent suppression.
